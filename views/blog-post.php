...
<head>
  ...
  <title>Ligula tristique quis risus - Ansynet</title>
...
<body>
  <div class="content-wrapper">
    ...
    <section class="wrapper">
      <div class="container pt-8 text-center">
        <div class="card bg-soft-primary rounded-4 mt-2 mb-13 mb-md-17">
          <div class="card-body p-md-10 py-xl-11 px-xl-15">
            <div class="row">
              <div class="col-md-10 col-xl-8 mx-auto">
                <div class="post-header">
                  <div class="post-category text-line text-dark">
                    <a href="#" class="text-reset" rel="category">Teamwork</a>
                  </div>
                  <!-- /.post-category -->
                  <h1 class="display-1 mb-4 text-dark">Commodo Dolor Bibendum Parturient Cursus Mollis</h1>
                  <ul class="post-meta text-dark">
                    <li class="post-date"><i class="uil uil-calendar-alt"></i><span>5 Jul 2022</span></li>
                    <li class="post-author"><i class="uil uil-user"></i><a href="#" class="text-reset"><span>By Ansynet</span></a></li>
                    <li class="post-comments"><i class="uil uil-comment"></i><a href="#" class="text-reset">3<span> Komentar</span></a></li>
                  </ul>
                  <!-- /.post-meta -->
                </div>
                <!-- /.post-header -->
    ...
    <section class="wrapper bg-light">
      <div class="container py-4 py-md-4">
        <div class="row gx-lg-8 gx-xl-12">
                        ...
                        <div class="mb-0 mb-md-2">
                          <div class="dropdown share-dropdown btn-group">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="#"><i class="uil uil-whatsapp"></i>Whatsapp</a>
                              <a class="dropdown-item" href="#"><i class="uil uil-instagram"></i>Instagram</a>
          ...
          <!-- /column -->
          <?php include('../views/partial/blog-sidebar.php'); ?>
          <!-- /column .sidebar -->
        </div>
        <!-- /.row -->
      </div>
